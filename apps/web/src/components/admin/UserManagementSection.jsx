            ...
            >
                {isDetailLoading ? (
                    ...
                    <Descriptions column={1} bordered size="small">
                        ...
                        <Descriptions.Item label={t('admin.users.manage.attributes.registrationIp')}>{selectedAccount.registrationIpAddress || selectedAccount.RegistrationIpAddress || '-'}</Descriptions.Item>
                        <Descriptions.Item label={t('admin.users.manage.attributes.registrationUserAgent')}>{selectedAccount.registrationUserAgent || selectedAccount.RegistrationUserAgent || '-'}</Descriptions.Item>
                        <Descriptions.Item label={t('admin.users.manage.attributes.registrationDeviceId')}>{selectedAccount.registrationDeviceId || selectedAccount.RegistrationDeviceId || '-'}</Descriptions.Item>
                    </Descriptions>
                ) : null}
            </Drawer>
