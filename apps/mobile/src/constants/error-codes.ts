export const ERROR_CODE_MESSAGES: Record<string, string> = {
  INVALID_PHONE_NUMBER: 'Telefon numarasi gecersiz.',
  OTP_INVALID: 'Dogrulama kodu hatali.',
  OTP_EXPIRED: 'Dogrulama kodunun suresi doldu.',
  ...
  REPORT_400_SELF: 'Kendi hesabini veya kendi etkinligini raporlayamazsin.',
